...
export class CompanyController {
  ...
  @Patch(':comp_nbr')
  update_company(@Param('comp_nbr') comp_nbr: number, @Body() company: CreateCompanyDto) {
    return this.companyService.update_company(+comp_nbr, company.Comp_name, company.Address);
  }
